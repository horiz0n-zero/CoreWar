...
/*   Updated: 2019/12/09 14:39:57 by afeuerst         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	process->r[process->opcode_data.params[2]] = process->r[process->opcode_data.params[0]] + process[process->opcode_data.params[1]];
}
